...
public class PlayerController : MonoBehaviour
{
    ...
    void checkBorder ( )
    {
        ...
        if (getDir != Vector3.zero)
        {
            ...
            allHit = Physics.RaycastAll (thisTrans.position - new Vector3 (0, 0.5f, 0), getDir, 0.5f);
    ...
    void emptyBag ( )
    {
        ...
        BagObj.SetParent (currParent.transform);
        currParent.transform.LookAt (thisWB.transform);
    ...
    void animeDead (Vector3 pointColl)
    {
        ...
        allHit = Physics.RaycastAll (thisTrans.position - new Vector3 (0, 0.5f, 0), getDirect, getDist);
