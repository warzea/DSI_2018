...
Shader "Custom/SHA_chest"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_cast_3 = (( ( 1.0 - step( sin( ( ( ( ase_worldPos * 0.01 ).z + ( ase_worldPos * 0.01 ).y + ( ase_worldPos * 0.01 ).x + ( _Time.y * 1.0 ) + frac( sin( ( ( transform62.x + transform62.y + transform62.z + transform62.w ) * 14996.2 ) ) ) ) + 0.0 ) ) , 0.99999 ) ) * 0.3 * ( 1.0 - _Desaturate ) )).xxx;
...
/*ASEBEGIN
Version=14101
7;29;1906;1004;960.6541;596.222;1;False;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;53;-1443.03,1011.983;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;1.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;76;31.34595,-16.22198;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT2;0.0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;73;157.5816,922.4725;Float;False;Constant;_Float1;Float 1;5;0;Create;0.3;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=863754304645634E15E6FF65A2C14C99AFB6BA89