		...
		SubShader
		{
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float4 lerpResult9 = lerp( float4(0.3382353,0.9178501,1,1) , float4(1,1,1,1) , tex2DNode1.g);
...
/*ASEBEGIN
Version=14101
1927;29;1586;824;998;493;1;True;True
...
Node;AmplifyShaderEditor.ColorNode;11;-581,-234;Float;False;Constant;_Color1;Color 1;1;0;Create;0.3382353,0.9178501,1,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;9;-330,-148;Float;False;3;0;COLOR;0.0;False;1;COLOR;0.0,0,0,0;False;2;FLOAT;0.0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-143,48;Float;False;3;3;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;COLOR;0.0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=2FE6DC664198ADD9F5A5F26B199CA46DF29B0890